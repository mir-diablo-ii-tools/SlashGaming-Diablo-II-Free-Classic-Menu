...
#ifndef SGD2FCM_PATCHES_MUSIC_MUSIC_PATCHES_H_
#define SGD2FCM_PATCHES_MUSIC_MUSIC_PATCHES_H_
...
struct MusicPatches {
  struct D2Sound_MainMenuMusicPatch d2sound_replace_music;
};
...
void MusicPatches_Remove(struct MusicPatches* patches);

#endif  /* SGD2FCM_PATCHES_MUSIC_MUSIC_PATCHES_H_ */
