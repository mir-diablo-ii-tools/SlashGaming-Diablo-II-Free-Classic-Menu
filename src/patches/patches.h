...
#ifndef SGD2FCM_PATCHES_PATCHES_H_
#define SGD2FCM_PATCHES_PATCHES_H_

#include "patches/music/music_patches.h"
#include "patches/ui/ui_patches.h"

struct Patches {
  struct MusicPatches music_patches;
  struct UiPatches ui_patches;
};
...
#endif  /* SGD2FCM_PATCHES_PATCHES_H_ */
