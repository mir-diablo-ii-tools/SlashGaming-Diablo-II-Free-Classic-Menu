...
struct D2Launch_TcpIpGameScreenBackgroundPatch
  ...
  switch (D2_GameVersion_GetRunning()) {
    ...
    case D2_GameVersion_kLod1_14D:
      patch.as_1_07 = D2Launch_TcpIpGameScreenBackgroundPatch_1_07_Init();
      break;
  }
...
void D2Launch_TcpIpGameScreenBackgroundPatch_Deinit(
  ...
  switch (D2_GameVersion_GetRunning()) {
    ...
    case D2_GameVersion_kLod1_14C:
    case D2_GameVersion_kLod1_14D:
      D2Launch_TcpIpGameScreenBackgroundPatch_1_07_Deinit(&patch->as_1_07);
      break;
  }
}
...
void D2Launch_TcpIpGameScreenBackgroundPatch_Apply(
  ...
  switch (D2_GameVersion_GetRunning()) {
    ...
    case D2_GameVersion_kLod1_14C:
    case D2_GameVersion_kLod1_14D:
      D2Launch_TcpIpGameScreenBackgroundPatch_1_07_Apply(&patch->as_1_07);
      break;
  }
}
