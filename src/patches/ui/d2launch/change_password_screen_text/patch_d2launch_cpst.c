...
struct D2Launch_ChangePasswordScreenTextPatch
  ...
  switch (D2_GameVersion_GetRunning()) {
    case D2_GameVersion_k1_07Beta:
      /* OK: Variable is uninitialized, but patch won't be used. */
      break;
    ...
    case D2_GameVersion_kLod1_14D:
      patch.as_1_07 = D2Launch_ChangePasswordScreenTextPatch_1_07_Init();
      break;
  }
...
void D2Launch_ChangePasswordScreenTextPatch_Deinit(
  ...
  switch (D2_GameVersion_GetRunning()) {
    ...
    case D2_GameVersion_kLod1_14C:
    case D2_GameVersion_kLod1_14D:
      D2Launch_ChangePasswordScreenTextPatch_1_07_Deinit(&patch->as_1_07);
      break;
  }
}
...
void D2Launch_ChangePasswordScreenTextPatch_Apply(
  ...
  switch (D2_GameVersion_GetRunning()) {
    ...
    case D2_GameVersion_kLod1_14C:
    case D2_GameVersion_kLod1_14D:
      D2Launch_ChangePasswordScreenTextPatch_1_07_Apply(&patch->as_1_07);
      break;
  }
}
